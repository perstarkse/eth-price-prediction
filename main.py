...
from mfles import fit_and_predict
from eval_catboost import catboost_eval
...
print(len(response["prices"]), 'days worth of transactions')
...
def mfls_predict(dataset, prediction_length):
    forecast = fit_and_predict(dataset, prediction_length)
